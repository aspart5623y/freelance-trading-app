...
use App\Repository\Investor\AccountRepository;
use App\Http\Requests\Investor\SendProofRequest;
...
class AccountController extends Controller
{
    ...
    public function bank()
    {
        ...
        return view('v1.investor.bank-account', compact('accounts'));
    }

    public function crypto()
    {
        $accounts = auth()->user()->account;
        return view('v1.investor.crypto-account', compact('accounts'));
    }

    public function paypal()
    {
        $accounts = auth()->user()->account;
        return view('v1.investor.paypal-account', compact('accounts'));
    }
    ...
    public function transfer()
    {
        ...
        return view('v1.investor.transfer-fund', compact('transfers'));
    }
    ...
    public function fund()
    {
        ...
        return view('v1.investor.fund-wallet', compact('accounts', 'deposits'));
    }
    ...
    public function fundWallet(Request $request)
    {
        ...
        if ($save) {
            return redirect()->route('investor.fund.wallet')->with('success', 'You have successfully uploaded your proof of payment. Your account would be funded as soon as your payment is confirmed');
        } else {
    ...
    public function walletTransfer(Request $request)
    {
        ...
        return redirect()->route('investor.wallet.address', ['amount' => $request->amount, 'account' => $request->coin]);
    }

    public function walletAddress($amount, $account)
    {
        $account = Account::find($account);
        return view('v1.investor.wallet-address', compact('amount', 'account'));
    }
