    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-12 col-md-7">
                <div class="card card-body border-0 mb-4">
                    <h5 class="fw-bold"><i class="fa fa-coins" aria-hidden="true"></i> &nbsp; Company's Wallet Address</h5>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-end">
                        ...
                        <form id="delete-form" action="{{ route('admin.delete.account') }}" method="POST" class="d-none">
                            @csrf
