                ...
                <table class="table table-borderless data-table"> 
                    <thead> 
                        <tr> 
                            ...
                            <th class="text-muted text-uppercase">investor</th> 
                    ...
                    <tbody> 
                        ...
                        @foreach ($investments as $item) 
                            <tr class="border-bottom"> 
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-muted">{{ $item->package->title }}</a>
                                </td> 
                                <td>
                                    <a href="{{ route('admin.user.show', $item->trader->profile->id) }}" class="text-muted">{{ $item->trader->firstname . ' ' . $item->trader->lastname }}</a>
                                </td> 
                                <td>
                                    <a href="{{ route('admin.user.show', $item->investor->profile->id) }}" class="text-muted">{{ $item->investor->firstname . ' ' . $item->investor->lastname }}</a>
                                </td> 
                                <td>{{ $item->package->duration }}days</td> 
                                <td>${{ $item->amount * ($item->package->roi/100) }}</td> 
                                <td> 
                    ...
                    fetch(`/investment/details/${$payload}`)
                        ...
                        .then(data => {
                            ...
                            $('#investmentDetails').html(`
                                ...
                                <tr>
                                    <th>Package Name</th>
                                    <td><a href="javascript:void(0)" class="text-success">${data.investment.package_title}</a></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>Trader</th>
                                    <td><a href="/admin/user/${data.investment.trader_profile_id}" class="text-success">${data.investment.trader_name}</a></td>
                                </tr>
                                <tr>
                                    <th>Investor</th>
                                    <td><a href="/admin/user/${data.investment.investor_profile_id}" class="text-success">${data.investment.investor_name}</a></td>
                                </tr>
                                <tr>
                                    <th>Amount</th>
