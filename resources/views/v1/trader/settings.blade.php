    ...
    <div class="row justify-content-center my-5">
        <div class="col-xl-5 col-lg-6 col-md-8">
            ...
            <div class="card card-body border-0 d-block">
                <a href="{{ route('trader.password') }}" class="text-dark btn w-100 text-start border-0 py-0">
                ...
                <hr>
                <a href="{{ route('trader.check') }}" class="text-dark btn w-100 text-start border-0 py-0">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-end">
                        ...
                        <form id="delete-form" action="{{ route('trader.delete.profile') }}" method="POST" class="d-none">
                            @csrf
