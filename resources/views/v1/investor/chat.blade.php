            ...
            <div class="card card-body message-card border-0 h-100">
                <form id="messageForm">
                    ...
                    @if ($conversation->sender_id == auth()->user()->id)
                        <a href="{{ route('investor.trader.show', $conversation->recieverProfile->id) }}">
                            <div class="d-flex border-bottom pb-2 align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <small class="text-muted">
                                        ...
                                        @endphp
                                        <i class="fas fa-star text-warning"></i> {{ $conversation->recieverProfile->profileable->show_admin_rating ? $conversation->recieverProfile->profileable->admin_rating : $rate1 }} Star rating | <small class="text-success">you can click here to see all about this trader</small>
                                        
                    @elseif($conversation->reciever_id == auth()->user()->id)
                        <a href="{{ route('investor.trader.show', $conversation->senderProfile->id) }}">
                            <div class="d-flex border-bottom pb-2 align-items-center">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <small class="text-muted">
                                        @php
                                            $rate2 = $conversation->senderProfile->profileable->ratings->count() > 0 ? $conversation->senderProfile->profileable->ratings()->sum('rating')/$conversation->senderProfile->profileable->ratings()->count() : 0
                                        @endphp
                                        <i class="fas fa-star text-warning"></i> {{ $conversation->senderProfile->profileable->show_admin_rating ? $conversation->senderProfile->profileable->admin_rating : $rate2 }} Star rating | <small class="text-success">you can click here to see all about this trader</small>
                    @endif
                                </small>
                            </div>
                        </div>
