...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap align-items-center mb-5">
        <div>
            ...
            <p class="text-muted">
                This table contains a list of all your withdrawals on this platform.
            </p>
        </div>
        <div class="text-end">
            ...
            <a href="{{ route('investor.withdrawal.create') }}" class="btn btn-success">Request withdrawal</a>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    @foreach ($withdrawals as $item)
                        <tr class="border-bottom">
                            ...
                            <td>
                                <button type="button" data-id="{{ $item->id }}" class="btn btn-sm btn-danger">
